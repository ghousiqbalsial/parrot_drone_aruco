...
class Drone(object):
    ...
    def move(self, leftright, backwardforward, downup,
        ...
        if turnleftright < -1.0:        turnleftright = -1.0
        leftright = self.__checkSpeedValue(leftright*0.5)
        backwardforward = self.__checkSpeedValue(backwardforward*0.5)
        downup = self.__checkSpeedValue(downup*0.5)
        turnleftright = self.__checkSpeedValue(turnleftright*0.5)
